    ...
    public class HVRInputManager : MonoBehaviour
    {
        ...
        public string XRPluginLoader
        {
            ...
            set
            {
                ...
                {
#if USING_OPENXR
                    //Debug.Log($"OpenXR Runtime: {OpenXRRuntime.name}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
#endif
                }
            }
        }
...
#pragma warning restore 0618
        ...
        private void OnDeviceDisconnected(InputDevice device)
        {
            if (_applicationExiting)
                return;
            //Debug.Log($"disconnected {device.name},{device.manufacturer}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        ...
        private void OnDeviceConnected(InputDevice device)
        {
            if (_applicationExiting)
                return;
            //Debug.Log($"connected {device.name},{device.manufacturer}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        ...
        private HVRController UpdateController(HVRControllerType controllerType, InputDevice device, HVRHandSide side)
        {
            ...
            {
                //Debug.Log($"InputSDK : {CurrentSDK}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
            }
...
#endif
            //Debug.Log($"{  XRGeneralSettings.Instance.Manager.automaticLoading}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
            //Debug.Log($"XRGeneralSettings.Instance.Manager.isInitializationComplete { XRGeneralSettings.Instance.Manager.isInitializationComplete}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
            //Debug.Log($"XRPlugin Detected | XRSettings.enabled {XRSettings.enabled} | Loader : {XRPluginLoader} | Loaders Enabled: {loaders}");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        ...
        {
#if USING_XR_MANAGEMENT
            //Debug.Log($"stopping xr plugin");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        ...
        private IEnumerator UpdateTrackingOrigin(TrackingOriginModeFlags originFlags)
        {
            ...
            //Debug.Log("Found " + subsystems.Count + " input subsystems.");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

            for (int i = 0; i < subsystems.Count; i++)
            {
                if (subsystems[i].TrySetTrackingOriginMode(originFlags))
                {
                    //Debug.Log("Successfully set TrackingOriginMode to Floor");XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
                }
                else
