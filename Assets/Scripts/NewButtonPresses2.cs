    ...
    public class NewButtonPresses2 : MonoBehaviour
    {
        ...
        void AButtonMethod(InputAction.CallbackContext obj)
        {
            ...
            if (Guns)
            {
                ...
                else if ((CurrentEquipped > 0) & (CurrentEquipped < 20))  //This disables the numbers 1-19
                {
                    CurrentEquipped = 20;
                }
                ...
                {
                    Grabber.ForceRelease();   //This makes you have nothing in your hand
